...
def get_stock(asin_list, market='US'):
    ...
    data_pd = pd.DataFrame(info_list, columns=['ASIN', 'stock', 'model'])
    time.sleep(5)
    driver.close()
    return data_pd
...
if __name__ == '__main__':
    ...
    asin_list = ['B07VZD6TK7', 'B07W53WCJR', 'B07XHJ9G26', 'B07W41326L', 'B07W1HL5Z9', 'B07XJ4428B']
    aft = datetime.datetime.now().strftime("%m%d%H%M")
    get_stock(asin_list=asin_list).to_excel('stock_' + aft + '.xlsx')
